// Per-session adviser state, persisted as a custom session entry.
// Ported verbatim from upstream compact-adviser packages/pi-extension/src/state.ts
// at pinned commit b2a27b59ce86af4dc8fb5141e169bfbed1e68cee; only the
// SessionEntry import target changed to the OMP package.
