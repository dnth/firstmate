...
The verified harnesses are `claude`, `codex`, `opencode`, `pi`, `pi-signed`, `omp`, `grok`, and `kimi`, plus `hermes` for crewmates and scouts only; never dispatch on an unverified adapter.
