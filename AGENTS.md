...
config/omp-max-time  optional override of the default 3h OMP runtime bound on OMP workers this home launches; LOCAL, gitignored, and not inherited; see docs/configuration.md "OMP runtime bound"
