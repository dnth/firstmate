...
fm_backend_tmux_omp_trigger_turn() {  # <target> <ready-marker> <omp-runtime> <omp-bin> <request-id>
  local target=$1 marker=$2 expected_bun=$3 expected_omp=$4 request_id=$5 pane_pid foreground_pid comm args
