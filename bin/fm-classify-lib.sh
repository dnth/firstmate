...
# The three parsers are pure reads of a single line; the verb parser takes the
# first whitespace-delimited token before the colon so optional tokens cannot
# alter the leading verb.
