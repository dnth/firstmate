...
# Presented records stay queued until their post-handling acknowledgement, so the
# queued-wakes warning below can still fire during the handling turn itself.
