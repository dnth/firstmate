...
family_for_basename() {
  case "$1" in
    ...
    fm-wake-queue.test.sh|fm-inbox.test.sh|fm-watch-arm.test.sh|fm-watch-checkpoint.test.sh|fm-watch-recovery-loop.test.sh|\
...
portable_serial_weight_hints() {
  cat <<'EOF'
tests/fm-afk-inject-e2e.test.sh 34487
tests/fm-afk-pi-herdr-return-e2e.test.sh 68
tests/fm-afk-return.test.sh 1658
tests/fm-ask-user-authority.test.sh 138
tests/fm-backend-cmux-smoke.test.sh 30
tests/fm-backend-cmux.test.sh 3164
tests/fm-backend-herdr-focus-flash-e2e.test.sh 21
tests/fm-backend-orca.test.sh 17239
tests/fm-backend-tmux-smoke.test.sh 236
tests/fm-backend-zellij-smoke.test.sh 23
tests/fm-backend-zellij.test.sh 6312
tests/fm-backend.test.sh 18832
tests/fm-backlog-handoff.test.sh 3343
tests/fm-bearings-snapshot.test.sh 76333
tests/fm-bootstrap.test.sh 48013
tests/fm-busy-adapter-wiring.test.sh 16180
tests/fm-busy-state.test.sh 2821
tests/fm-calm-pi-extension.test.sh 260
tests/fm-check-unregister.test.sh 363
...
tests/fm-gitignore-config.test.sh 25
tests/fm-gotmp.test.sh 713
tests/fm-grok-continuity-live-e2e.test.sh 20
tests/fm-grok-stop-live-e2e.test.sh 21
tests/fm-guard-stale-banner.test.sh 5417
tests/fm-herdr-session-cleanup.test.sh 5524
tests/fm-hermes-harness.test.sh 125003
tests/fm-hermes-live-e2e.test.sh 43
tests/fm-kimi-harness.test.sh 14636
...
tests/fm-omp-secondmate.test.sh 31991
tests/fm-omp-task-inbox-doorbell.test.sh 3980
tests/fm-omp-update.test.sh 546
tests/fm-omp-worker-tmux-live-e2e.test.sh 17
tests/fm-on.test.sh 8664
tests/fm-opencode-primary-live-e2e.test.sh 16
tests/fm-operational-input.test.sh 209
tests/fm-pending-reply-sleep-reconcile.test.sh 243
tests/fm-pending-reply.test.sh 9640
...
tests/fm-public-followup.test.sh 31910
tests/fm-quota-array-dispatch-live-e2e.test.sh 19
tests/fm-receipt-check.test.sh 51306
tests/fm-receipt.test.sh 1331
tests/fm-remote-backlog-handoff.test.sh 19860
tests/fm-remote-doctor.test.sh 5721
tests/fm-remote-entrypoint.test.sh 208
tests/fm-remote-job.test.sh 49588
tests/fm-remote-reply.test.sh 15792
tests/fm-remote-secondmate-lifecycle-e2e.test.sh 268606
tests/fm-remote-secondmate-parent-binding.test.sh 11721
tests/fm-remote-secondmate-trace-context.test.sh 57709
tests/fm-runpod-lifecycle.test.sh 53737
tests/fm-runpod-omp-auth.test.sh 1116
tests/fm-runpod-pod-boot.test.sh 43939
tests/fm-runpod-routing.test.sh 35106
tests/fm-secondmate-harness.test.sh 145625
tests/fm-secondmate-lifecycle-e2e.test.sh 5372
tests/fm-secondmate-liveness.test.sh 17658
tests/fm-secondmate-safety.test.sh 42637
tests/fm-secondmate-sync.test.sh 22153
tests/fm-send-inbox-doorbell-live-e2e.test.sh 23
tests/fm-send-inbox.test.sh 39575
tests/fm-send-resolve-key.test.sh 13556
tests/fm-send-secondmate-marker-herdr-e2e.test.sh 48
tests/fm-send-secondmate-marker.test.sh 6020
tests/fm-send-turn-start.test.sh 11033
tests/fm-session-lock-ancestry.test.sh 1284
tests/fm-session-start.test.sh 60247
tests/fm-sessionstart-nudge.test.sh 370
tests/fm-shared-captain-inheritance.test.sh 6041
tests/fm-spawn-dispatch-profile.test.sh 166845
tests/fm-spawn-pool-base-freshen.test.sh 24428
tests/fm-spawn-worktree-settle.test.sh 5788
tests/fm-startup-memory-budget.test.sh 7325
tests/fm-subagent-pretool-check.test.sh 972
tests/fm-supervision-events.test.sh 462
tests/fm-tangle-guard.test.sh 8087
tests/fm-task-delivery.test.sh 7831
tests/fm-task-inbox.test.sh 23833
tests/fm-teardown-endpoint-safety.test.sh 1797
tests/fm-teardown.test.sh 131227
tests/fm-test-fixture-cleanup.test.sh 542
tests/fm-test-isolation-proof.test.sh 489
tests/fm-todo-project.test.sh 4979
tests/fm-trace-context-lib.test.sh 1580
tests/fm-trace-context-spawn.test.sh 36595
tests/fm-treehouse-orphan-recovery.test.sh 123
tests/fm-turnend-guard.test.sh 18956
tests/fm-update.test.sh 5305
tests/fm-vendor-auth-probe.test.sh 42858
tests/fm-wake-daemon-lifecycle-e2e.test.sh 18907
tests/fm-wake-drain-open-decisions-cursor.test.sh 15961
tests/fm-wake-drain-open-decisions.test.sh 3443
tests/fm-wake-drain-unread-status.test.sh 9808
tests/fm-wake-queue.test.sh 58726
tests/fm-watch-arm.test.sh 69318
tests/fm-watch-checkpoint.test.sh 4861
tests/fm-watch-recovery-loop.test.sh 57851
tests/fm-watch-triage.test.sh 262420
tests/fm-watcher-lock.test.sh 86539
EOF
}
