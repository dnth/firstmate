...
family_for_basename() {
  case "$1" in
    ...
    fm-brief.test.sh|fm-receipt.test.sh|fm-receipt-check.test.sh|fm-vendor-auth-probe.test.sh|\
    ...
    fm-test-run.test.sh|fm-test-isolation-proof.test.sh|fm-omp-branch-types.test.sh)
      printf '%s\n' pure-contract-unit
      ;;
    ...
    fm-afk-herdr-atomic-admission-smoke.test.sh|\
    ...
    fm-omp-update.test.sh|fm-session-start.test.sh|fm-sessionstart-nudge.test.sh|fm-tangle-guard.test.sh|\
    fm-update.test.sh)
      printf '%s\n' session-bootstrap
      ;;
...
portable_serial_weight_hints() {
  cat <<'EOF'
tests/fm-afk-inject-e2e.test.sh 35157
tests/fm-afk-pi-herdr-return-e2e.test.sh 85
tests/fm-afk-return.test.sh 1551
tests/fm-ask-user-authority.test.sh 82
tests/fm-backend-cmux-smoke.test.sh 33
tests/fm-backend-cmux.test.sh 2845
tests/fm-backend-herdr-focus-flash-e2e.test.sh 21
tests/fm-backend-orca.test.sh 15189
tests/fm-backend-tmux-smoke.test.sh 338
tests/fm-backend-zellij-smoke.test.sh 23
tests/fm-backend-zellij.test.sh 6530
tests/fm-backend.test.sh 19653
tests/fm-backlog-handoff.test.sh 3063
tests/fm-bearings-snapshot.test.sh 67705
tests/fm-bootstrap.test.sh 55789
tests/fm-busy-adapter-wiring.test.sh 15133
tests/fm-busy-state.test.sh 644
tests/fm-calm-pi-extension.test.sh 230
tests/fm-claude-stop-autoarm-live-e2e.test.sh 19
tests/fm-claude-stop-autoarm.test.sh 60727
tests/fm-codex-continuity-live-e2e.test.sh 21
tests/fm-daemon.test.sh 26636
tests/fm-documentation-audiences.test.sh 687
tests/fm-fleet-snapshot-view.test.sh 6926
tests/fm-fleet-sync.test.sh 18756
tests/fm-gate-refuse.test.sh 4037
tests/fm-gitignore-config.test.sh 29
tests/fm-gotmp.test.sh 521
tests/fm-grok-continuity-live-e2e.test.sh 19
tests/fm-grok-stop-live-e2e.test.sh 21
tests/fm-guard-stale-banner.test.sh 6140
tests/fm-herdr-session-cleanup.test.sh 5868
tests/fm-hermes-harness.test.sh 118095
tests/fm-hermes-live-e2e.test.sh 38
tests/fm-kimi-harness.test.sh 14569
tests/fm-omp-harness.test.sh 1662
tests/fm-omp-herdr-exit-live-e2e.test.sh 21
tests/fm-omp-herdr-live-e2e.test.sh 21
tests/fm-omp-max-time-live-e2e.test.sh 18
tests/fm-omp-primary-live-e2e.test.sh 19
tests/fm-omp-primary.test.sh 4747
tests/fm-omp-secondmate-live-e2e.test.sh 20
tests/fm-omp-secondmate.test.sh 33480
tests/fm-omp-update.test.sh 661
tests/fm-omp-worker-tmux-live-e2e.test.sh 20
tests/fm-on.test.sh 8774
tests/fm-opencode-primary-live-e2e.test.sh 19
tests/fm-operational-input.test.sh 220
tests/fm-pending-reply-sleep-reconcile.test.sh 209
tests/fm-pending-reply.test.sh 9199
tests/fm-pi-compatible-family.test.sh 64
tests/fm-pi-primary-live-e2e.test.sh 19
tests/fm-pi-watch-extension.test.sh 19068
tests/fm-pr-check-security.test.sh 241502
tests/fm-procevent.test.sh 49546
tests/fm-public-followup.test.sh 35431
tests/fm-quota-array-dispatch-live-e2e.test.sh 21
tests/fm-remote-backlog-handoff.test.sh 21022
tests/fm-remote-doctor.test.sh 6054
tests/fm-remote-entrypoint.test.sh 264
tests/fm-remote-job.test.sh 48865
tests/fm-remote-reply.test.sh 9107
tests/fm-remote-secondmate-lifecycle-e2e.test.sh 206025
tests/fm-remote-secondmate-parent-binding.test.sh 13357
tests/fm-remote-secondmate-trace-context.test.sh 52341
tests/fm-runpod-lifecycle.test.sh 53456
tests/fm-runpod-omp-auth.test.sh 1156
tests/fm-runpod-pod-boot.test.sh 45396
tests/fm-runpod-routing.test.sh 31301
tests/fm-secondmate-harness.test.sh 135312
tests/fm-secondmate-lifecycle-e2e.test.sh 6385
tests/fm-secondmate-liveness.test.sh 21887
tests/fm-secondmate-safety.test.sh 43349
tests/fm-secondmate-sync.test.sh 19388
tests/fm-send-resolve-key.test.sh 8344
tests/fm-send-secondmate-marker-herdr-e2e.test.sh 49
tests/fm-send-secondmate-marker.test.sh 4394
tests/fm-send-turn-start.test.sh 10885
tests/fm-session-lock-ancestry.test.sh 1470
tests/fm-session-start.test.sh 69097
tests/fm-sessionstart-nudge.test.sh 323
tests/fm-shared-captain-inheritance.test.sh 5286
tests/fm-spawn-dispatch-profile.test.sh 106490
tests/fm-spawn-pool-base-freshen.test.sh 23922
tests/fm-spawn-worktree-settle.test.sh 5765
tests/fm-startup-memory-budget.test.sh 7116
tests/fm-subagent-pretool-check.test.sh 1061
tests/fm-supervision-events.test.sh 501
tests/fm-tangle-guard.test.sh 8352
tests/fm-task-delivery.test.sh 1870
tests/fm-teardown-endpoint-safety.test.sh 1589
tests/fm-teardown.test.sh 76980
tests/fm-test-fixture-cleanup.test.sh 556
tests/fm-test-isolation-proof.test.sh 476
tests/fm-todo-project.test.sh 5196
tests/fm-trace-context-lib.test.sh 1993
tests/fm-trace-context-spawn.test.sh 34532
tests/fm-treehouse-orphan-recovery.test.sh 144
tests/fm-turnend-guard.test.sh 16761
tests/fm-update.test.sh 5207
tests/fm-vendor-auth-probe.test.sh 42935
...
tests/fm-watch-recovery-loop.test.sh 58263
tests/fm-watch-triage.test.sh 237330
tests/fm-watcher-lock.test.sh 88005
EOF
}
...
families_for_changed_path() {
  ...
  case "$path" in
    ...
    bin/fm-watch*|bin/fm-wake*|bin/fm-daemon*|bin/fm-turnend-guard*|bin/fm-guard.sh)
      printf '%s\n' watcher-wake-lock
      ;;
    bin/fm-lease*|bin/fm-branch-outcome.sh|bin/fm-branch-prompt.sh|\
    .omp/extensions/fm-branch-supervision-omp.ts|.omp/extensions/lib/fm-branch-dispatch.ts|\
    ...
    bin/fm-install-herdr.sh|bin/fm-install-treehouse.sh|bin/fm-herdr-ci-cleanup.sh)
      ...
      printf '%s\n' real-herdr-gated
      ;;
    bin/fm-todo-project.sh)
      printf '%s\n' pure-contract-unit
      printf '%s\n' session-bootstrap
      ;;
    bin/fm-lint.sh|bin/fm-install-shellcheck.sh|\
    bin/fm-brief.sh|bin/fm-receipt.sh|bin/fm-receipt-check.sh|bin/fm-receipt-schema.sh|bin/fm-receipt-store.sh|\
