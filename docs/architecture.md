...
`bin/fm-omp-capabilities.sh` owns the selected Bun-backed OMP launch and recovery capability checks before endpoint publication, and selection never falls back to Pi or another harness.
