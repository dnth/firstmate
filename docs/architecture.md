...
OMP busy-submit confirmation remains backend-specific and fail-closed; the [tmux](tmux-backend.md#current-behavior-and-safety) and [Herdr](herdr-backend.md#current-transport-behavior) guides own the current proof contracts.
