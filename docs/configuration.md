...
FM_BACKEND_HERDR_SEPARATED_COMPOSER_MAX_LINES=8  # herdr-only: maximum rows admitted inside the separator-framed Claude payload-proof composer; taller or ambiguous candidates stay unknown (docs/herdr-backend.md "Composer and injection safety")
