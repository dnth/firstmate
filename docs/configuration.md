...
FM_WATCH_RESURFACE_MAX_ANNOUNCEMENTS=3   # unacknowledged downtime announcements before an armed watcher resumes pane supervision instead of exiting on the resurface wake (docs/watcher-continuity.md "Recovery episode acknowledgement")
