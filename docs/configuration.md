...
FM_TASK_INBOX_RING_MAX=3     # watcher doorbell attempts before custody-checked stall recovery runs; an ordinary stale wake follows only when recovery defers or escalates
