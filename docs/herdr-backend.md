...
An unavailable or unacknowledged programmatic surface falls back to the same guarded composer doorbell, while every non-OMP harness stays on that composer path.
