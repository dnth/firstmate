...
This exception is read-only: launch, send, and retirement still require the seeded-home marker, and an unreachable host remains unknown with its route preserved.
