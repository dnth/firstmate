...
| `fm-supervise-daemon.sh` | Presence-gated away-mode sub-supervisor: self-handle routine wakes, guard delivery by the detected primary harness, escalate batched digests, alert on deferred delivery |
