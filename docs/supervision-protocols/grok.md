...
5. Do not invent a wake from an attach-status line alone.
   Drain the queue and act only on real wake records, the drain's `OPEN DECISIONS`, `UNREAD STATUS`, or STATUS OUTCOME BACKSTOP entries, or a real watcher reason line.
