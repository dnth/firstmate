...
OLD_BIN_UNCHANGED_SIBLINGS="fm-gate-refuse-lib.sh fm-guard.sh fm-lock-lib.sh fm-tasks-axi-lib.sh fm-pr-lib.sh fm-tangle-lib.sh fm-tmux-lib.sh fm-composer-lib.sh fm-wake-lib.sh fm-classify-lib.sh fm-supervision-lib.sh fm-ff-lib.sh fm-config-inherit-lib.sh fm-project-mode.sh fm-harness.sh fm-crew-state.sh fm-nm-run-lib.sh fm-decision-hold.sh fm-captain-hold.sh fm-backlog-transition-lib.sh fm-parent-channel-lib.sh fm-timeout-lib.sh fm-backend.sh fm-operational-input.sh fm-public-followup-lib.sh fm-runpod-lib.sh fm-secondmate-registry-lib.sh fm-secondmate-parent-lib.sh fm-x-lib.sh fm-busy-lib.sh fm-session-lock-lib.sh"
OLD_BIN_UNCHANGED_SIBLINGS="fm-gate-refuse-lib.sh fm-guard.sh fm-lock-lib.sh fm-tasks-axi-lib.sh fm-pr-lib.sh fm-tangle-lib.sh fm-tmux-lib.sh fm-composer-lib.sh fm-wake-lib.sh fm-classify-lib.sh fm-supervision-lib.sh fm-ff-lib.sh fm-config-inherit-lib.sh fm-project-mode.sh fm-harness.sh fm-crew-state.sh fm-nm-run-lib.sh fm-decision-hold.sh fm-captain-hold.sh fm-backlog-transition-lib.sh fm-parent-channel-lib.sh fm-timeout-lib.sh fm-backend.sh fm-operational-input.sh fm-public-followup-lib.sh fm-runpod-lib.sh fm-secondmate-registry-lib.sh fm-secondmate-parent-lib.sh fm-x-lib.sh fm-busy-lib.sh fm-session-lock-lib.sh"
...
OLD_BIN_OPTIONAL_SIBLINGS="fm-backlog-transition-lib.sh fm-timeout-lib.sh fm-pending-reply-lib.sh fm-omp-process-lib.sh fm-task-inbox-lib.sh fm-pool-lib.sh fm-homes-lib.sh fm-treehouse-root-lib.sh fm-treehouse-command.sh fm-lease-lib.sh fm-secondmate-nudge-lib.sh fm-env-lib.sh"
